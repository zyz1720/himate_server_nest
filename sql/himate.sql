...
-- 导出 himate 的数据库结构
CREATE DATABASE IF NOT EXISTS `himate` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `himate`;
...
CREATE TABLE IF NOT EXISTS `chat` (
  ...
  `msgdata` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `favorites` (
  ...
  `favorites_name` varchar(48) COLLATE utf8_unicode_ci NOT NULL COMMENT '收藏夹名',
...
CREATE TABLE IF NOT EXISTS `file` (
  ...
  `file_hash` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT '文件hash',
...
CREATE TABLE IF NOT EXISTS `mate` (
  ...
  `validate_msg` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '验证消息',
...
CREATE TABLE IF NOT EXISTS `music` (
  ...
  `artist` varchar(96) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '音乐艺术家',
  `artists` json DEFAULT NULL COMMENT '音乐艺术家数组',
  `album` varchar(96) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '专辑名',
  `create_time` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `update_time` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS `music_more` (
  ...
  `match_id` varchar(16) COLLATE utf8_unicode_ci NOT NULL COMMENT '匹配第三方音乐id',
  `music_name` varchar(96) COLLATE utf8_unicode_ci NOT NULL COMMENT '音乐名称',
  `music_singer` varchar(96) COLLATE utf8_unicode_ci NOT NULL COMMENT '音乐作者',
  `music_album` varchar(96) COLLATE utf8_unicode_ci NOT NULL COMMENT '专辑名',
  `music_cover` varchar(96) COLLATE utf8_unicode_ci NOT NULL COMMENT '音乐封面',
  `music_lyric` text COLLATE utf8_unicode_ci COMMENT '标准歌词',
  `music_trans` text COLLATE utf8_unicode_ci COMMENT '翻译歌词',
  `music_yrc` text COLLATE utf8_unicode_ci COMMENT '逐字歌词',
  `music_roma` text COLLATE utf8_unicode_ci COMMENT '音译歌词',
  `create_time` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
  `update_time` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '更新时间',
